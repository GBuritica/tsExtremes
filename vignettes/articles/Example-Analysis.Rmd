...
In the case of regularly varying random variables, the variance and the mean can sometimes equal infinity. This means that sampling from this variable, we obtain highly scattered observations in comparison with light-tailed distributions. To see this consider the following sample, and its respective boxplot.
...
sample_pareto      <- rpareto(n, shape=alpha)
```
